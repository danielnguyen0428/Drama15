...
export function buildSettingSeedPrompt(params: {
  ...
  return {
    ...
    userPrompt: [
      ...
      customNicheLockInstruction(request),
      "For billionaire_rich_poor_romance, titleHint must center the rich-poor love story. Use courtship-led patterns: 'He Chose The Poor Bride In Front Of His Family', 'Rich Boy Pretends To Be Poor To Find Real Love', 'Scholarship Girl Loved By The Heir Of The Foundation', 'Tutor Falls For The Rich Family's Lonely Son', 'Cinderella Of The Charity Gala', 'She Walked Away To Protect Him From His Mother'. Title must read like a romance hook (love, choice, family opposition), not contract / divorce / merger / sa thải / xé hợp đồng. If the natural angle is contract wife, paper marriage, ex-wife revenge, secret baby, or female billionaire comeback, route the seed to workplace_ceo_power_struggle instead.",
      "For workplace_ceo_power_struggle, titleHint must use first-person webnovel viral format with corporate-power reversal. Examples: 'Đuổi Tôi Khỏi Cuộc Họp, Tôi Sa Thải Tổng Tài', 'Ký Giấy Ly Hôn Xong, Anh Mới Biết Tôi Là Ai', 'Xé Hợp Đồng Của Tôi? Tôi Xé Luôn Công Ty Anh', 'Fired Me? I Own Your Company Now', 'Signed My Divorce, Then Begged Me To Stay', 'Pregnant Secretary Refused The CEO's Buyout', 'After Divorce She Bought His Company', 'The Hidden Heiress Signed As His Secretary'. Heroine speaks directly, short punchy clauses, power reversal visible in the title.",
      "For every other Niche, choose the closest matching title pattern from the Line preset seriesExamples and Auto-generation topic catalog, then create an original title with the same CTR shape.",
